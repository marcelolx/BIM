...
public class DAOManager {
	...
	public static Dao<Procedures, Integer> proceduresDAO;
	...
	static {
		try {
			...
			TableUtils.createTableIfNotExists(Connection.getConection(), Procedures.class);
			...
			proceduresDAO = DaoManager.createDao(Connection.getConection(), Procedures.class);
