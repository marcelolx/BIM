...
public class TabJacksonPollockHomensAtletas {
	...
	public static void init(JTabbedPane mainPane) {
		...
		lblPeitoral.setBounds(calcPaneWidthSizeToSetComponents(mainPane)+calcMid(mainPane, 7)-50, 40, 90, 22);
		...
		txtPeitoral.setBounds(calcPaneWidthSizeToSetComponents(mainPane)+calcMid(mainPane, 7)+43, 40, 45, 22);
		...
		lblAxilarMedia.setBounds(calcPaneWidthSizeToSetComponents(mainPane)+calcMid(mainPane, 7)+92, 40, 120, 22);
		...
		txtAxilarMedia.setBounds(calcPaneWidthSizeToSetComponents(mainPane)+calcMid(mainPane, 7) + 215, 40, 45, 22);
		...
		lblTriceps.setBounds(calcPaneWidthSizeToSetComponents(mainPane)+calcMid(mainPane, 7)+ 260, 40, 90, 22);
		...
		txtTriceps.setBounds(calcPaneWidthSizeToSetComponents(mainPane)+calcMid(mainPane, 7)+350, 40, 45, 22);
		...
		lblSubscapular.setBounds(calcPaneWidthSizeToSetComponents(mainPane)+calcMid(mainPane, 7)-10, 72, 120, 22);
		...
		txtSubscapular.setBounds(calcPaneWidthSizeToSetComponents(mainPane)+calcMid(mainPane, 7)+112, 72, 45, 22);
		...
		lblAbdomen.setBounds(calcPaneWidthSizeToSetComponents(mainPane)+calcMid(mainPane, 7)+162, 72, 100, 22);
		...
		txtAbdomen.setBounds(calcPaneWidthSizeToSetComponents(mainPane)+calcMid(mainPane, 7)+265, 72, 45, 22);
		...
		lblSupraIliaca.setBounds(calcPaneWidthSizeToSetComponents(mainPane)+calcMid(mainPane, 7)-9, 104, 120, 22);
		...
		txtSupraIliaca.setBounds(calcPaneWidthSizeToSetComponents(mainPane)+calcMid(mainPane, 7)+112, 104, 45, 22);
		...
		lblCoxa.setBounds(calcPaneWidthSizeToSetComponents(mainPane)+calcMid(mainPane, 7)+180, 104, 90, 22);
		...
		txtCoxa.setBounds(calcPaneWidthSizeToSetComponents(mainPane)+calcMid(mainPane, 7)+265, 104, 45, 22);
